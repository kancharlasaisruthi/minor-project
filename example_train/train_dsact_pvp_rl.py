...
if __name__ == "__main__":
    ...
    parser.add_argument("--load_human_buffer", type=bool)
    ...
    parser.add_argument("--buffer_path", type=str, default= 'C:/Users/saika/minor_project/C-HAC/results/DSAC_V2_PVP_RL_gym_metadrivepvp/260128-222729/buf_508.pkl')
    #
